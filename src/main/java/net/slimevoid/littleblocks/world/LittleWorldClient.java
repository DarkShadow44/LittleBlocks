...
public class LittleWorldClient extends World implements ILittleWorld {
    ...
    public LittleWorldClient(World referenceWorld, ISaveHandler saveHandler, String worldName, WorldProvider provider,
        WorldSettings worldSettings, int difficultySetting, Profiler profiler) {
        super(saveHandler, worldName, provider, worldSettings, profiler);
        this.isRemote = true;
        String name = referenceWorld.getWorldInfo()
    ...
    public EntityPlayer getClosestPlayer(double x, double y, double z, double distance) {
        return this.getLittleWorld()
            .getClosestPlayer(x, y, z, distance);
    }
