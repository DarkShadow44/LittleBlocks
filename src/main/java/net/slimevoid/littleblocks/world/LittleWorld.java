...
public abstract class LittleWorld extends World implements ILittleWorld {
        ...
        while (iterator.hasNext()) {
            ...
            if (!tileentity.isInvalid() && tileentity.hasWorldObj()
                ...
                try {
                    ...
                    SlimevoidCore.console(CoreLib.MOD_ID, t.getLocalizedMessage(), LogLevel.WARNING.ordinal());
                    LoggerLittleBlocks.getInstance(
                        Logger.filterClassName(
                            this.getClass()
                                .toString()))
                        .write(
                            this.getParentWorld().isRemote,
                            "updateEntities(" + tileentity.toString()
                                + ", "
                                + tileentity.xCoord
                                + ", "
                                + tileentity.yCoord
            ...
            if (tileentity.isInvalid()) {
                ...
                TileEntity tileentitylb = this.getParentWorld()
                    .getTileEntity(tileentity.xCoord >> 3, tileentity.yCoord >> 3, tileentity.zCoord >> 3);
                if (tileentitylb != null && tileentitylb instanceof TileEntityLittleChunk) {
                    ((TileEntityLittleChunk) tileentitylb)
                        .removeInvalidTileEntity(tileentity.xCoord & 7, tileentity.yCoord & 7, tileentity.zCoord & 7);
                }
            }
        }
            ...
            for (int i = 0; i < this.addedTileEntityList.size(); ++i) {
                ...
                if (!tileentity.isInvalid()) {
                    ...
                    TileEntity tileentitylb = this.getParentWorld()
                        .getTileEntity(tileentity.xCoord >> 3, tileentity.yCoord >> 3, tileentity.zCoord >> 3);
                    if (tileentitylb != null && tileentitylb instanceof TileEntityLittleChunk) {
                        ((TileEntityLittleChunk) tileentitylb).removeInvalidTileEntity(
                            tileentity.xCoord & 7,
                            tileentity.yCoord & 7,
                            tileentity.zCoord & 7);
                    }
    ...
    public int getSkyBlockTypeBrightness(EnumSkyBlock enumskyblock, int x, int y, int z) {
        if (this.getParentWorld() != null) {
            return this.getParentWorld()
                .getSkyBlockTypeBrightness(enumskyblock, x >> 3, y >> 3, z >> 3);
        } else {
            LoggerLittleBlocks.getInstance(
                Logger.filterClassName(
                    this.getClass()
    ...
    public int getLightBrightnessForSkyBlocks(int x, int y, int z, int l) {
        if (this.getParentWorld() != null) {
            return this.getParentWorld()
                .getLightBrightnessForSkyBlocks(x >> 3, y >> 3, z >> 3, l);
        } else {
            LoggerLittleBlocks.getInstance(
                Logger.filterClassName(
                    this.getClass()
    ...
    public float getLightBrightness(int x, int y, int z) {
        if (this.getParentWorld() != null) {
            return this.getParentWorld()
                .getLightBrightness(x >> 3, y >> 3, z >> 3);
        } else {
            LoggerLittleBlocks.getInstance(
                Logger.filterClassName(
                    this.getClass()
                        .toString()))
                .write(this.getParentWorld().isRemote, "getBrightness().[null]", LoggerLittleBlocks.LogLevel.DEBUG);
            return 0;
        }
    }
        ...
        if (x >= 0xfe363c80 && z >= 0xfe363c80 && x < 0x1c9c380 && z < 0x1c9c380) {
            if (y >= 0) {
                if (y >= this.getHeight()) {
                    ...
                    if (chunk.getBlock((x & 0x7f) >> 3, y >> 3, (z & 0x7f) >> 3) != ConfigurationLib.littleChunk
                        && this.isAirBlock(x, y, z)) {
                        this.getParentWorld()
                            .setLightValue(sky, x >> 3, y >> 3, z >> 3, MathHelper.floor_double(value / 8));
                    } else
                        if (chunk.getBlock((x & 0x7f) >> 3, y >> 3, (z & 0x7f) >> 3) != ConfigurationLib.littleChunk) {
                            return;
                        }
                    ...
                    tile.setLightValue(x & 7, y & 7, z & 7, value);
    ...
    public int getBlockLightValue(int x, int y, int z) {
        if (this.getParentWorld() != null) {
            return this.getParentWorld()
                .getBlockLightValue(x >> 3, y >> 3, z >> 3);
        } else {
            LoggerLittleBlocks.getInstance(
                Logger.filterClassName(
                    this.getClass()
    ...
    public int getFullBlockLightValue(int x, int y, int z) {
        return this.getParentWorld()
            .getFullBlockLightValue(x >> 3, y >> 3, z >> 3);
    }

    @Override
    public boolean canBlockSeeTheSky(int x, int y, int z) {
        return this.getParentWorld()
            .canBlockSeeTheSky(x >> 3, y >> 3, z >> 3);
    }
    ...
    public boolean isOutdated(World world) {
        boolean outdated = !this.getParentWorld()
            .equals(world);
        if (outdated) {
            LoggerLittleBlocks.getInstance(
                Logger.filterClassName(
    ...
    public boolean blockExists(int x, int y, int z) {
        ...
        if (y >= this.getHeight()) {
            ...
            Block block = this.getParentWorld()
                .getChunkFromChunkCoords(x >> 7, z >> 7)
                .getBlock((x & 0x7f) >> 3, y >> 3, (z & 0x7f) >> 3);
    ...
    public boolean spawnEntityInWorld(Entity entity) {
        entity.setPosition(
            entity.posX / ConfigurationLib.littleBlocksSize,
        ...
        LoggerLittleBlocks.getInstance(
            ...
            .write(
                ...
                "spawnEntityInWorld(" + entity
                    .getEntityId() + ").[" + entity.posX + ", " + entity.posY + ", " + entity.posZ + "]",
                LoggerLittleBlocks.LogLevel.DEBUG);
        return this.getParentWorld()
            .spawnEntityInWorld(entity);
    }
        ...
        if (x >= 0xfe363c80 && z >= 0xfe363c80 & x < 0x1c9c380 && z < 0x1c9c380) {
            if (y < 0) {
                ...
                if (chunk.getBlock((x & 0x7f) >> 3, y >> 3, (z & 0x7f) >> 3) != ConfigurationLib.littleChunk
                    && this.isAirBlock(x, y, z)) {
                    this.getParentWorld()
                        .setBlock(x >> 3, y >> 3, z >> 3, ConfigurationLib.littleChunk);
                ...
                if (!this.isRemote || (update & 8) != 0) {
                    ...
                    tile.setBlockIDWithMetadata(x & 7, y & 7, z & 7, block, newmeta);
                }
            }
        } else {
            LoggerLittleBlocks.getInstance(
            ...
            if (chunk.getBlock((x & 0x7f) >> 3, y >> 3, (z & 0x7f) >> 3) == ConfigurationLib.littleChunk) {
                ...
                if (tileentity == null) {
                    TileEntityLittleChunk tile = (TileEntityLittleChunk) this.getParentWorld()
                        .getTileEntity(x >> 3, y >> 3, z >> 3);
                    if (tile != null) {
                        tileentity = tile.getChunkTileEntity(x & 7, y & 7, z & 7);
                    }
                }
    ...
    public void setTileEntity(int x, int y, int z, TileEntity tileentity) {
        ...
        if (chunk.getBlock((x & 0x7f) >> 3, y >> 3, (z & 0x7f) >> 3) == ConfigurationLib.littleChunk) {
            ...
            this.func_147453_f(x, y, z, getBlock(x, y, z));
        } else {
            this.getParentWorld()
                .setTileEntity(x >> 3, y >> 3, z >> 3, tileentity);
        }
    }
    ...
    @Override
    public MovingObjectPosition func_147447_a/* rayTraceBlocks_do_do */(Vec3 Vec3, Vec3 Vec31, boolean flag,
        ...
        return super.func_147447_a/* rayTraceBlocks_do_do */(Vec3, Vec31, flag, flag1, flag2);
    }
    ...
    public EntityPlayer getClosestVulnerablePlayer(double x, double y, double z, double distance) {
        return this.getClosestPlayer(x, y, z, distance);
    }
    ...
    public int getSavedLightValue(EnumSkyBlock enumskyblock, int x, int y, int z) {
        ...
        if (y >= this.getHeight()) {
            ...
            if (id == ConfigurationLib.littleChunk) {
                TileEntityLittleChunk tile = (TileEntityLittleChunk) this.getParentWorld()
                    .getTileEntity(x >> 3, y >> 3, z >> 3);
                return tile.getSavedLightValue(x & 7, y & 7, z & 7);
            } else {
    ...
    public boolean updateLightByType(EnumSkyBlock enumskyblock, int x, int y, int z) {
        ...
        if (this.doChunksNearChunkExist(x, y, z, 17)) {
            int lightCount = 0;
            int changeCount = 0;
            int savedLight = this.getSavedLightValue(enumskyblock, x, y, z);
            int computedLight = this.computeLightValue(x, y, z, enumskyblock);
            int l1;
            int i2;
            int j2;
            int k2;
            ...
            if (computedLight > savedLight) {
                ...
                while (lightCount < changeCount) {
                    ...
                    k2 = (l1 >> 12 & 63) - 32 + z;
                    l2 = l1 >> 18 & 15;
                    i3 = this.getSavedLightValue(enumskyblock, i2, j2, k2);

                    if (i3 == l2) {
                        this.setLightValue(enumskyblock, i2, j2, k2, 0);
            ...
            while (lightCount < changeCount) {
                ...
                j2 = (l1 >> 6 & 63) - 32 + y;
                k2 = (l1 >> 12 & 63) - 32 + z;
                l2 = this.getSavedLightValue(enumskyblock, i2, j2, k2);
                i3 = this.computeLightValue(i2, j2, k2, enumskyblock);

                if (i3 != l2) {
                    this.setLightValue(enumskyblock, i2, j2, k2, i3);
                    ...
                    if (i3 > l2) {
                        ...
                        if (j3 + l3 + k3 < 17 && flag) {
                            if (this.getSavedLightValue(enumskyblock, i2 - 1, j2, k2) < i3) {
                                this.lightUpdateBlockList[changeCount++] = i2 - 1
                                    - x
                                    + 32
                                    + (j2 - y + 32 << 6)
                                    + (k2 - z + 32 << 12);
                            ...
                            if (this.getSavedLightValue(enumskyblock, i2, j2 - 1, k2) < i3) {
                                this.lightUpdateBlockList[changeCount++] = i2 - x
                                    + 32
                                    + (j2 - 1 - y + 32 << 6)
                                    + (k2 - z + 32 << 12);
                            }
                            ...
                            if (this.getSavedLightValue(enumskyblock, i2, j2, k2 - 1) < i3) {
                                this.lightUpdateBlockList[changeCount++] = i2 - x
                                    + 32
                                    + (j2 - y + 32 << 6)
                                    + (k2 - 1 - z + 32 << 12);
    ...
    @Override
    public List selectEntitiesWithinAABB(Class entityClass, AxisAlignedBB axisalignedbb,
        IEntitySelector entitySelector) {
        ArrayList arraylist = new ArrayList();
        int minX = MathHelper.floor_double((axisalignedbb.minX - MAX_ENTITY_RADIUS) / 16.0D);
        int maxX = MathHelper.floor_double((axisalignedbb.maxX + MAX_ENTITY_RADIUS) / 16.0D);
    ...
    @Override
    public boolean canPlaceEntityOnSide(Block block, int x, int y, int z, boolean flag, int side, Entity entityPlacing,
        ItemStack itemstack) {
        Block blockAt = this.getBlock(x, y, z);
        ...
        if (axisalignedbb != null && !this.checkNoEntityCollision(axisalignedbb, entityPlacing)) {
            ...
            if (blockAt != null && (blockAt == Blocks.flowing_water || blockAt == Blocks.water
            ...
            if (blockAt != null && blockAt.isReplaceable(this, x, y, z)) {
                blockAt = null;
            }

            return blockAt != null && blockAt.getMaterial() == Material.circuits && block == Blocks.anvil ? true
                : block != Blocks.air && blockAt == null && block.canPlaceBlockOnSide(this, x, y, z, side);
        }
    }
