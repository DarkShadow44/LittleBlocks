...
public class LittleWorldServer extends WorldServer implements ILittleWorld {
    ...
    public LittleWorldServer(World referenceWorld, MinecraftServer minecraftServer, ISaveHandler iSaveHandler,
    ...
    protected void func_147456_g/* tickBlocksAndAmbiance */() {
        this.getLittleWorld()
            .func_147456_g/* tickBlocksAndAmbiance */();
    }
    ...
    public boolean isBlockTickScheduledThisTick(int x, int y, int z, Block blockId) {
        return this.getLittleWorld()
            .isBlockTickScheduledThisTick(x, y, z, blockId);
    }
    ...
    public Explosion newExplosion(Entity entity, double x, double y, double z, float strength, boolean isFlaming,
        boolean isSmoking) {
        return this.getLittleWorld()
            .newExplosion(entity, x, y, z, strength, isFlaming, isSmoking);
    }
    ...
    public void addBlockEvent(int x, int y, int z, Block blockID, int eventID, int eventParam) {
        this.getLittleWorld()
            .addBlockEvent(x, y, z, blockID, eventID, eventParam);
    }

    @Override
    public List<NextTickListEntry> getPendingBlockUpdates(Chunk chunk, boolean forceRemove) {
        return this.getLittleWorld()
            .getPendingBlockUpdates(chunk, forceRemove);
    }
    ...
    public void scheduleBlockUpdateWithPriority(int x, int y, int z, Block blockId, int tickRate, int someValue) {
        this.getLittleWorld()
            .scheduleBlockUpdateWithPriority(x, y, z, blockId, tickRate, someValue);
    }
    ...
    public void func_147446_b/* scheduleBlockUpdateFromLoad */(int x, int y, int z, Block blockId, int tickRate,
        int par6) {
        this.getLittleWorld()
            .func_147446_b/* scheduleBlockUpdateFromLoad */(x, y, z, blockId, tickRate, par6);
    }

    public int getSkyBlockTypeBrightness(EnumSkyBlock enumskyblock, int x, int y, int z) {
        return this.getLittleWorld()
            .getSkyBlockTypeBrightness(enumskyblock, x, y, z);
    }
    ...
    public boolean setBlock(int x, int y, int z, Block blockID, int newmeta, int update) {
        ...
        return this.getLittleWorld()
            .setBlock(x, y, z, blockID, newmeta, update);
    }
    ...
    public boolean setBlockMetadataWithNotify(int x, int y, int z, int newmeta, int update) {
        ...
        return this.getLittleWorld()
            .setBlockMetadataWithNotify(x, y, z, newmeta, update);
    }

    @Override
    public boolean checkChunksExist(int minX, int minY, int minZ, int maxX, int maxY, int maxZ) {
        return this.getLittleWorld()
            .checkChunksExist(minX, minY, minZ, maxX, maxY, maxZ);
    }
    ...
    public void notifyBlockOfNeighborChange(int x, int y, int z, Block blockId) {
        this.getLittleWorld()
            .notifyBlockOfNeighborChange(x, y, z, blockId);
    }
    ...
    public void func_147448_a/* addTileEntity */(Collection collection) {
        this.getLittleWorld()
            .func_147448_a/* addTileEntity */(collection);
    }
    ...
    public void func_147457_a/* markTileEntityForDespawn */(TileEntity tileentity) {
        this.getLittleWorld()
            .func_147457_a/* markTileEntityForDespawn */(tileentity);
    }
    ...
    public MovingObjectPosition func_147447_a/* rayTraceBlocks_do_do */(Vec3 Vec3, Vec3 Vec31, boolean flag,
        ...
        return this.getLittleWorld()
            .func_147447_a/* rayTraceBlocks_do_do */(Vec3, Vec31, flag, flag1, flag2);
    }
    ...
    public EntityPlayer getClosestPlayer(double x, double y, double z, double distance) {
        ...
        EntityPlayer entityplayer = this.getParentWorld()
            .getClosestPlayer(blockX >> 3, blockY >> 3, blockZ >> 3, distance);
    ...
    public EntityPlayer getClosestVulnerablePlayer(double x, double y, double z, double distance) {
        return this.getLittleWorld()
            .getClosestVulnerablePlayer(x, y, z, distance);
    }
    ...
    public void markBlockRangeForRenderUpdate(int x, int y, int z, int x2, int y2, int z2) {
        this.getLittleWorld()
            .markBlockRangeForRenderUpdate(x, y, z, x2, y2, z2);
    }
    ...
    public boolean updateLightByType(EnumSkyBlock enumSkyBlock, int x, int y, int z) {
        return this.getLittleWorld()
            .updateLightByType(enumSkyBlock, x, y, z);
    }
    ...
    @Override
    public boolean canPlaceEntityOnSide(Block blockId, int x, int y, int z, boolean flag, int side,
        Entity entityPlacing, ItemStack itemstack) {
        return this.getLittleWorld()
            .canPlaceEntityOnSide(blockId, x, y, z, flag, side, entityPlacing, itemstack);
    }
    ...
    public List getEntitiesWithinAABBExcludingEntity(Entity entity, AxisAlignedBB axisalignedbb,
        ...
        return this.getLittleWorld()
            .getEntitiesWithinAABBExcludingEntity(entity, axisalignedbb, entitySelector);
    }
    ...
    public void activeChunkPosition(ChunkPosition chunkposition, boolean forced) {
        this.getLittleWorld()
            .activeChunkPosition(chunkposition, forced);
    }
    ...
    public void addLoadedTileEntity(TileEntity tileentity) {
        this.getLittleWorld()
            .addLoadedTileEntity(tileentity);
    }
