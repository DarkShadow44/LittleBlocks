...
public class DrawCopierHighlight {
    ...
    public void drawInWorldCopierOverlay(DrawBlockHighlightEvent event) {
        ...
        Block blockID = world.getBlock(
            event.target.blockX + (int) xShift,
    ...
    private boolean shouldDoDraw(World world, int blockX, int blockY, int blockZ) {
        ...
        return block == ConfigurationLib.littleChunk || block.isReplaceable(world, blockX, blockY, blockZ);
    }

    public static void renderPulsingQuad(TextureManager renderEngine, ResourceLocation wandOverlay,
