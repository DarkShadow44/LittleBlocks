...
public class LBCore {
    ...
    public static void registerItems() {
        ConfigurationLib.littleBlocksWand = new ItemLittleBlocksWand(ConfigurationLib.littleBlocksWandID)
            .setUnlocalizedName(ItemLib.WAND);
    ...
    public static void registerRecipes() {
        GameRegistry.addRecipe(
            new ItemStack(ConfigurationLib.littleBlocksWand),
            new Object[] { "LIL", "BGB", "BWB", Character.valueOf('L'), new ItemStack(Items.dye, 9, 4),
                Character.valueOf('I'), Items.iron_ingot, Character.valueOf('B'), new ItemStack(Items.dye, 1, 0),
                Character.valueOf('G'), Items.gold_nugget, Character.valueOf('W'), Blocks.wool });
    }
    ...
    public static void registerPistonOverride() {
        ...
        GameRegistry.registerBlock(newPistonSticky, "pistonStickyBase");
        GameRegistry.registerBlock(newPistonBase, "pistonBase");
    ...
    public static void registerDoorOverride() {
        ...
        // false);
        Block newDoorWood = new BlockLBDoor(64, Material.wood).setHardness(3.0F)
            .setStepSound(Block.soundTypeWood)
            .setBlockName("doorWood")
            .setBlockTextureName("door_wood");
        Block newDoorIron = new BlockLBDoor(71, Material.iron).setHardness(5.0F)
            .setStepSound(Block.soundTypeMetal)
            .setBlockName("doorIron")
            .setBlockTextureName("door_iron");
        GameRegistry.registerBlock(newDoorWood, "doorWood");
        GameRegistry.registerBlock(newDoorIron, "doorIron");
